...
static_assert(offsetof(SYSTICK::Register, CALIB_REG) == 0x0c, "systick CALIB_REG at wrong offset");
...
inline NVIC_ISER::Register *iser() {
   return reinterpret_cast<NVIC_ISER::Register *>(NVIC_ISER::BASE);
}
